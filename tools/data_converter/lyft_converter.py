...
def create_lyft_infos(root_path,
    ...
    if version == 'v1.01-train':
        train_scenes = mmcv.list_from_file(osp.join(root_path,'train.txt'))
        val_scenes = mmcv.list_from_file(osp.join(root_path,'val.txt'))
    elif version == 'v1.01-test':
        train_scenes = mmcv.list_from_file(osp.join(root_path,'test.txt'))
        val_scenes = []
    else:
