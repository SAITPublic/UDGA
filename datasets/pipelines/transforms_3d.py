...
from mmdet3d.core.bbox import (RAYInstance3DBoxes, CameraInstance3DBoxes, DepthInstance3DBoxes,
...
class ObjectRangeFilter(object):
    ...
    def __call__(self, input_dict):
        ...
        if isinstance(input_dict['gt_bboxes_3d'],
                      (LiDARInstance3DBoxes, DepthInstance3DBoxes, RAYInstance3DBoxes)):
        ...
        try:
            ...
            print(gt_labels_3d.shape, mask.shape)
            raise ValueError
